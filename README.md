...
[Licensed under the GPL](./LICENSE.md). Copyright 2011-2020 by [the contributors](https://github.com/WordPress/gutenberg/commits/master/packages/components/src/slot-fill).
